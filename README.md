...
Nu hvor vi har initieret modellens parametre, kan vi fitte den til vores data ved at bruge den rekursive forward-backward algoritme, vha. EM-algoritmen, til at maksimere $`p(X\vertt \pi, A, \Phi`$ ved at justere parametrene, således denne sandsynlighed er konvergeret eller algortimen er kørt igennem 50 iterationer. Vi har brugt følgende kode til dette:
